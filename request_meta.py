...
def genFilePayload(file_ids,payloadfile):
    ...
    filters = {
        ...
        "format":"TSV",
        "fields":"file_id,file_name,cases.project.disease_type,cases.submitter_id,cases.case_id,data_category,data_type,cases.diagnoses.tissue_or_organ_of_origin,cases.samples.tumor_descriptor,cases.samples.tissue_type,cases.samples.sample_type,cases.samples.submitter_id,cases.samples.sample_id,cases.samples.portions.analytes.aliquots.aliquot_id,cases.samples.portions.analytes.aliquots.submitter_id",
        "pretty":"true",
        "size":"1500"
    }
    json_str = json.dumps(filters)
